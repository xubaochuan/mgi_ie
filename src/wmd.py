...
class WMD(object):
    def __init__(self, w2v_filepath = '../model/wordvec0921.txt'):
        self.model = nlp_utility.load_word2vec(w2v_filepath)

    def get_sentence_vec(self, sentence_list, idf_enable = False):
        if idf_enable == True:
            ...
            for j in range(s_len):
                ...
                for m, q_wordvec in enumerate(query_vec_list[i]):
                    ...
                    for s_wordvec in candidate_vec_list[j]:
                        ...
                        distance = cosine_distance(q_wordvec, s_wordvec)
